...
if __name__ == "__main__":
    ...
    if not args.demo:
        ...
        if accelerator.process_index == 0:
            ...
            with open("results/cfg.txt", "a") as file:
                print(f"CFG {train_config['sample']['cfg_scale']}, CFG Interval {train_config['sample']['cfg_interval_start']} -- FID-{train_config['sample']['fid_num']} {fid}", file=file)
